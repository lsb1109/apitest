...
class TextFormatRunner:
    ...
    def request_function(input_method, uri, body):
        ...
        header = getattr(TextFormatRunner, "reg2apikey")("eyJ1ciI6ImxzYjExMDkiLCJwZyI6ImNpbSIsImNuIjoiMlYzSXVYZ1BRdyJ9.75ef651fbfc63f59aaf07b199d2a0fa1edd6b8f522313512a265ab1bfd33feab")
